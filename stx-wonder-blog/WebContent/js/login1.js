...
jQuery.use.add([{name:"playmedia",files:["http://s.xnimg.cn/a36346/smallsite/scripts/modules/player/playmedia.js"],provides:["getVedioHTML","getAudioHTML"]},{name:"colorpicker",files:["http://s.xnimg.cn/a22582/smallsite/styles/modules/colorpicker/colorpicker.css","http://s.xnimg.cn/a36366/smallsite/scripts/modules/colorpicker/colorpicker.js"],provides:["jQuery.fn.colorPicker"]},{name:"swfupload",files:["http://s.xnimg.cn/a20426/smallsite/scripts/modules/swfupload/swfupload.js"],provides:["SWFUpload"]},{name:"zeroclipboard",files:["http://s.xnimg.cn/a29993/smallsite/scripts/modules/zeroclipboard/zeroclipboard.js"],provides:["ZeroClipboard"]}]);
...
this.dia=jQuery.alertDialog({title:"\u63d0\u793a",width:470,noPadding:false,confirmText:"\u5206\u4eab",message:this.getHtml()});
this.dia.getFooter().hide();
this.bindEvents();
},getHtml:function(){
return ["<div class=\"login-panel clearfix\">","<div class=\"data-box clearfix\">","<h2>\u8bf7\u5148\u767b\u5f55\uff0c\u53d1\u73b0\u66f4\u591a\u6709\u8da3\u7684\u5185\u5bb9\u54e6\uff01</h2>","<form name=\"loginForm\" action=\"http://www.renren.com/PLogin.do\" method=\"post\">","<input value=\""+window.location.href+"\" name=\"origURL\" type=\"hidden\" />","<input value=\"renren.com\" name=\"domain\" type=\"hidden\" />","<div class=\"item\"><input type=\"text\" class=\"input\" name=\"email\" id=\"email\"/><label for=\"email\" class=\"login-lab\">\u6ce8\u518c\u90ae\u7bb1</label></div>","<p class=\"user-tip\">\u53ef\u4ee5\u7528\u4eba\u4eba\u7f51\u5e10\u53f7\u767b\u5f55</p>","<div class=\"item\"><input id=\"password\" class=\"input\" name=\"password\" type=\"password\"/><label for=\"password\" class=\"login-lab\">\u8f93\u5165\u5bc6\u7801</label></div>","<p class=\"action\">","<span class=\"forget-password\"><a href=\"http://safe.renren.com/findPass.do\">\u5fd8\u8bb0\u5bc6\u7801</a></span>","<label style=\"margin-left:44px;margin-right:10px;\"><input class=\"input-checkbox\" value=\"true\" name=\"autoLogin\" type=\"checkbox\" />\u81ea\u52a8\u767b\u5f55</label><input value=\"\u767b\u5f55\" class=\"input-submit\" name=\"submit\" type=\"submit\" />","</p>","</form>","</div>","<div class=\"no-account\" >","<p class=\"no-tip\">\u8fd8\u6ca1\u6709\u5e10\u53f7\uff1f</p>","<p><a class=\"register-btn\" href=\"http://zhan.renren.com/reg\">\u7acb\u5373\u6ce8\u518c</a></p>","</div>","</div>"].join("");
},bindEvents:function(){
var that=this;
...
jQuery.extend({active:0,lastModified:{},etag:{},handleError:function(s,xhr,_5e9,e){
if(s.error){
s.error.call(s.context,xhr,_5e9,e);
}
if(s.global){
jQuery.triggerGlobal(s,"ajaxError",[xhr,s,e]);
}
},handleSuccess:function(s,xhr,_5ed,data){
if(s.success){
s.success.call(s.context,data,_5ed,xhr);
}
if(s.global){
jQuery.triggerGlobal(s,"ajaxSuccess",[xhr,s]);
}
},handleComplete:function(s,xhr,_5f1){
if(s.complete){
s.complete.call(s.context,xhr,_5f1);
}
if(s.global){
...
var _5f8=xhr.getResponseHeader("Last-Modified"),etag=xhr.getResponseHeader("Etag");
if(_5f8){
jQuery.lastModified[url]=_5f8;
}
if(etag){
...
(function(){
var jsc=jQuery.now(),_601=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,_602=/^(?:select|textarea)/i,_603=/^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,_604=/^(?:GET|HEAD)$/,_605=/\[\]$/,jsre=/\=\?(&|$)/,_607=/\?/,rts=/([?&])_=[^&]*/,rurl=/^(\w+:)?\/\/([^\/?#]+)/,r20=/%20/g,_60b=/#.*$/,_60c=jQuery.fn.load;
...
jQuery.ajax=function(_610){
var s=jQuery.extend(true,{},jQuery.ajaxSettings,_610),_612,_613,data,type=s.type.toUpperCase(),_616=_604.test(type);
s.url=s.url.replace(_60b,"");
s.context=_610&&_610.context!=null?_610.context:s;
...
if(type==="GET"){
if(!jsre.test(s.url)){
s.url+=(_607.test(s.url)?"&":"?")+(s.jsonp||"callback")+"=?";
}
}else{
...
_612=s.jsonpCallback||("jsonp"+jsc++);
if(s.data){
s.data=(s.data+"").replace(jsre,"="+_612+"$1");
}
s.url=s.url.replace(jsre,"="+_612+"$1");
s.dataType="script";
var _617=window[_612];
window[_612]=function(tmp){
if(jQuery.isFunction(_617)){
_617(tmp);
}else{
window[_612]=undefined;
try{
delete window[_612];
}
catch(jsonpError){
...
data=tmp;
jQuery.handleSuccess(s,xhr,_613,data);
jQuery.handleComplete(s,xhr,_613,data);
if(head){
head.removeChild(_61b);
}
};
}
...
if(s.cache===false&&_616){
var ts=jQuery.now();
var ret=s.url.replace(rts,"$1_="+ts);
s.url=ret+((ret===s.url)?(_607.test(s.url)?"&":"?")+"_="+ts:"");
}
if(s.data&&_616){
s.url+=(_607.test(s.url)?"&":"?")+s.data;
}
if(s.global&&jQuery.active++===0){
jQuery.event.trigger("ajaxStart");
}
var _61e=rurl.exec(s.url),_61f=_61e&&(_61e[1]&&_61e[1].toLowerCase()!==location.protocol||_61e[2].toLowerCase()!==location.host);
if(s.dataType==="script"&&type==="GET"&&_61f){
var head=document.getElementsByTagName("head")[0]||document.documentElement;
var _61b=document.createElement("script");
if(s.scriptCharset){
_61b.charset=s.scriptCharset;
}
_61b.src=s.url;
if(!_612){
var done=false;
_61b.onload=_61b.onreadystatechange=function(){
if(!done&&(!this.readyState||this.readyState==="loaded"||this.readyState==="complete")){
done=true;
jQuery.handleSuccess(s,xhr,_613,data);
jQuery.handleComplete(s,xhr,_613,data);
_61b.onload=_61b.onreadystatechange=null;
if(head&&_61b.parentNode){
head.removeChild(_61b);
}
}
};
}
head.insertBefore(_61b,head.firstChild);
return undefined;
}
var _621=null;
...
if(_610.type&&_610.type.toLowerCase()=="post"){
_610.data=_610.data?_610.data+"&":"";
_610.data+="_rtk="+_621;
return ajax(_610);
}
var _622=jQuery("<a />").attr("href",_610.url)[0].hostname;
var _623=jQuery("<a />").attr("href",_610.url)[0].port;
if(!arguments[1]&&_622&&_622!=location.hostname){
jQuery("<iframe />").attr({"src":"http://"+_622+"/ajaxproxy.htm","frameBorder":0,"width":0,"height":0}).appendTo("body").load(function(){
var that=this;
var _625=_610.success||function(){
};
_610.success=function(){
_625.apply(this,arguments);
jQuery(that).remove();
};
setTimeout(function(){
jQuery.ajax(_610,that.contentWindow);
},30);
});
...
try{
if((s.data!=null&&!_616)||(_610&&_610.contentType)){
...
var _627=xhr.onreadystatechange=function(_628){
if(!xhr||xhr.readyState===0||_628==="abort"){
if(!_626){
jQuery.handleComplete(s,xhr,_613,data);
}
_626=true;
...
if(!_626&&xhr&&(xhr.readyState===4||_628==="timeout")){
_626=true;
xhr.onreadystatechange=jQuery.noop;
_613=_628==="timeout"?"timeout":!jQuery.httpSuccess(xhr)?"error":s.ifModified&&jQuery.httpNotModified(xhr,s.url)?"notmodified":"success";
var _629;
if(_613==="success"){
try{
...
if(_613==="success"||_613==="notmodified"){
if(!_612){
jQuery.handleSuccess(s,xhr,_613,data);
}
}else{
jQuery.handleError(s,xhr,_613,_629);
}
if(!_612){
jQuery.handleComplete(s,xhr,_613,data);
}
...
xhr.abort=function(){
if(xhr){
Function.prototype.call.call(_62a,xhr);
}
_627("abort");
};
}
...
try{
xhr.send(_616||s.data==null?null:s.data);
}
catch(sendError){
...
SmallSite.autoResizeImg=function(_637,w,h){
var $=jQuery;
var _63b=$(_637);
if(!_63b||_63b.size()==0){
return;
...
var tmpl=(function(_641,$){
return function(str,data){
var fn=!/\s/.test(str)?_641[str]=_641[str]||tmpl(document.getElementById(str).innerHTML):function(data){
var i,_648=[$],_649=[[]];
for(i in data){
_648.push(i);
_649.push(data[i]);
}
return (new Function(_648,fn.$)).apply(data,_649).join("");
};
...
jQuery.fn.extend({getSize:function(_64a){
var img=new Image();
var src=this[0].src;
var _64d,_64e,_64f,_650;
var size={};
img.src=src;
if(img.complete){
...
_64f=img.width;
_650=img.height;
if(_64f!==_64d||_650!==_64e||img.complete){
size={"width":_64f,"height":_650};
_64a.call(img);
if(_652){
clearInterval(_652);
_652=null;
...
var _654=jQuery("#rogue-suggest");
if(jQuery(window).scrollTop()>1400&&!that.eBtn.hasClass("show")){
if(_654.length!==0){
_654.show();
that.eBtn.css("bottom","104px");
}
that.show();
...
this.eBtn.css("top",jQuery(window).scrollTop()+screen.height-370);
if(jQuery("#rogue-suggest").length!==0){
jQuery("#rogue-suggest").css("top",jQuery(window).scrollTop()+screen.height-370+81).show();
this.eBtn.css("top",jQuery(window).scrollTop()+screen.height-390);
}
}};
...
},setItem:function(key,_65e){
if(this.supportsLocalStorage()){
localStorage.setItem(key,_65e);
}else{
if(jQuery.browser.msie){
this.oUserData.load("renrenUserData");
this.oUserData.setAttribute(key,_65e);
...
SmallSite.app.common={toggleFollow:function(_662,url,data,_665,_666,_667){
jQuery.ajax({url:"http://zhan.renren.com/"+url+(_662?"/follow":"/unfollow")+(data?"?"+data:""),type:"post",dataType:"json",success:function(r){
if(r.code==0){
if(_665){
_665();
}else{
...
},toggleLike:function(_669,id,data,_66c,_66d,_66e){
var that=this;
jQuery.ajax({url:"http://zhan.renren.com/zhan/entry/"+id+(_669?"/like":"/unlike")+(data?"?"+data:""),type:"post",dataType:"json",success:function(r){
if(r.code==0){
if(_66c){
_66c();
}else{
...
},toggleTagFollow:function(_671,name,data,_674,_675,_676){
var that=this;
jQuery.ajax({url:"http://zhan.renren.com/tag/"+encodeURIComponent(name)+(_671?"/follow":"/unfollow")+(data?"?"+data:""),type:"post",dataType:"json",success:function(r){
if(r.code==0){
if(_674){
_674();
}else{
...
jQuery.fn.extend({showTip:function(_679){
var args=jQuery.extend({direction:"top",timeout:"100",popContent:"",xoffset:"center"},_679);
var data=(args.popContent=="")?(jQuery(this).attr("data-title")):args.popContent;
var _67c=jQuery("body");
var _67d=this.width()/2;
...
_680.prototype={init:function(){
var that=this;
if(_67c.find(".wrapPopLayer").length==0){
this.createDom();
}else{
...
var that=this;
var _683=jQuery("<div/>").addClass("wrapPopLayer").css({"left":left,"top":that.topp});
var _684=jQuery("<i/>");
if(args.direction=="top"){
_684.removeClass().addClass("pop-triangle");
}else{
_684.removeClass().addClass("pop-triangle-down");
}
var _685=(args.direction=="top")?"31px":"-31px";
var _686=jQuery("<div/>").addClass("popWrap").css({"margin-top":_685});
var _687=jQuery("<div/>").text(data).addClass("popcontent");
_67c.append(_683);
_683.append(_686);
_686.append(_684);
_686.append(_687);
...
jQuery(".popWrap").show();
jQuery(".wrapPopLayer").css({"left":left-jQuery(".popWrap").width()/2+_67d});
setTimeout(function(){
jQuery(".popWrap").css({"margin-top":"0px","opacity":"1"});
},100);
}};
new _680();
},hideTip:function(_688){
var args=jQuery.extend({animateEle:"this",autoClose:"false",direction:"top",timeout:"300"},_688);
var _68a=(args.direction=="top")?"31px":"-31px";
jQuery(".popWrap").css({"margin-top":_68a,"opacity":"0"});
setTimeout(function(){
jQuery(".popWrap").hide();
},200);
}});
...
SmallSite.app.scrollComponent=function(_68e){
this.args=jQuery.extend(paramsInterface,_68e);
this._init();
};
...
var _690=["<section id=\"newsfeed\" class=\"sitemain clearfix\"><div id =\"feed-container\">"+html+"</div></section>"].join("");
this.odEle.before(_690);
return jQuery("#newsfeed");
},wrapDom:function(_691){
var _692=this.odEle.height();
var _693=this.odEle.width();
if(document.getElementById("wrapDiv")!=null){
return;
}
this.odEle.wrap("<div id = \"wrapDiv\" style = \"position:absolute;\"></div>");
jQuery("#wrapDiv").height(_692);
jQuery("#wrapDiv").width(_693);
},setOldContainer:function(_694){
_694.addClass("oldfeedScroll");
...
var that=this;
var _698=this._getnwEleheight();
this.nwEle.css({opacity:1,visibility:"visible",top:"0px"});
this.odEle.css({top:_698+"px"});
...
var _699=jQuery("#sitemainold").find("ul.photo-list img");
SmallSite.feedPics.load(_699);
},1500);
